...
//            JSONArray parentArray = new JSONArray(json);
            ...
            jsvm.setProviderProfilePhoto(object.getString("ProviderProfilePhoto") == null? "":object.getString("ProviderProfilePhoto"));
            ...
            jsvm.setDeposit(object.getDouble("ClientDeposit"));
            jsvm.setExtraDeposit(object.getDouble("ClientExtraDeposit"));
            jsvm.setProviderDeposit(object.getDouble("ProviderDeposit"));
            jsvm.setType(object.getString("Type"));
            jsvm.setBudget(object.getDouble("Budget"));
            jsvm.setServiceRating(object.getDouble("ServiceRating"));
            ...
            jsvm.setPaymentMethod(object.getString("PaymentMethod"));
            ...
            jsvm.setDueDate(object.getString("Prediction"));
